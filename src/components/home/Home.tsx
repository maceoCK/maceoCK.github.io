        ...
        <div>
            <div className="info-container">
                <div className="info">
                    ...
                    <h1 className="info-title name">I'm Maceo Cardinale Kwik</h1>
                    <h2 className="info-subtitle">I hope you enjoy your stay at my website</h2>
                    ...
                    <div className="profile-image-border-1">
                        <div className="profile-image-border-2">
                            <div className="profile-image-border-3">
                                <img className="profile-image" src={MaceoProfile} alt="Maceo Cardinale Kwik" />
                            </div>
                        </div>
                    </div>
                </div>
